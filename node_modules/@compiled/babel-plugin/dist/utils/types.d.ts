...
export type CssItem = UnconditionalCssItem | ConditionalCssItem | LogicalCssItem | SheetCssItem | CssMapItem;
...
export type EvaluateExpression = (expression: t.Expression, meta: Metadata) => {
    value: t.Expression;
    meta: Metadata;
};
