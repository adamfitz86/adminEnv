...
export function IconWrapper({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ...
    className: ax([styles.root, sizeMap[size], isDataCenter ? colorMode === 'dark' ? dataCenterDarkAppearanceMap[appearance] : dataCenterLightAppearanceMap[appearance] : colorMode === 'dark' ? cloudDarkAppearanceMap[appearance] : cloudLightAppearanceMap[appearance]])
  });
}