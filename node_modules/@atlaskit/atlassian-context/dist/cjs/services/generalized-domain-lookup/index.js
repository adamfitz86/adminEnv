...
function getDomainForNonIsolatedCloud(subdomain, perimeter, envType) {
  ...
  if (override) {
    ...
    return (_override$perimeter$e = (_override$perimeter = override[perimeter]) === null || _override$perimeter === void 0 ? void 0 : _override$perimeter[envType]) !== null && _override$perimeter$e !== void 0 ? _override$perimeter$e : override[_constants.COMMERCIAL][_constants.PRODUCTION] // Default to commercial production if no environment-specific override is found
    ;
  }
