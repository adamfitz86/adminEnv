...
._14iu19ru:active:not(:disabled){background-color:var(--ds-background-selected-pressed,#85b8ff)}
._14iu1ji5:active:not(:disabled){background-color:var(--ds-surface-pressed,#dcdfe4)}
...
._1yyu1fvw{--notch-color:var(--ds-background-selected-bold,#0c66e4)}
