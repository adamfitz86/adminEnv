...
export function Aside(_ref) {
  ...
  React.createElement(DangerouslyHoistCssVarToDocumentRoot, {
    ...
    responsiveValue: fg('platform_design_system_nav4_live_resizing_css_vars') ? "var(".concat(panelSplitterResizingVar, ", ").concat(asideVariableWidth, ")") : asideVariableWidth
  })
  // ------ END UNSAFE STYLES ------
