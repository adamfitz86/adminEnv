 ...
 */
const asideWidthSlotBounds = {
  min: '0px',
  max: '50vw'
};
const asideWidthResizeBounds = {
  min: '120px',
  max: '50vw'
};
...
export function Aside({
  ...
  React.createElement(DangerouslyHoistCssVarToDocumentRoot, {
    ...
    responsiveValue: fg('platform_design_system_nav4_live_resizing_css_vars') ? `var(${panelSplitterResizingVar}, ${asideVariableWidth})` : asideVariableWidth
  })
  // ------ END UNSAFE STYLES ------
