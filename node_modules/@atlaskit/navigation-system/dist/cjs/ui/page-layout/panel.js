...
function Panel(_ref) {
  ...
  React.createElement(_hoistUtils.DangerouslyHoistCssVarToDocumentRoot, {
    ...
    responsiveValue: (0, _platformFeatureFlags.fg)('platform_design_system_nav4_live_resizing_css_vars') ? "var(".concat(panelSplitterResizingVar, ", ").concat(panelVariableWidth, ")") : panelVariableWidth
  })
  // ------ END UNSAFE STYLES ------
