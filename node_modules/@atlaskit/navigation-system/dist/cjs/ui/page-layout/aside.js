...
function Aside(_ref) {
  ...
  React.createElement(_hoistUtils.DangerouslyHoistCssVarToDocumentRoot, {
    ...
    responsiveValue: (0, _platformFeatureFlags.fg)('platform_design_system_nav4_live_resizing_css_vars') ? "var(".concat(panelSplitterResizingVar, ", ").concat(asideVariableWidth, ")") : asideVariableWidth
  })
  // ------ END UNSAFE STYLES ------
